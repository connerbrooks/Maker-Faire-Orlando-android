...
import com.makerfaireorlando.app.CalendarClient;
import com.makerfaireorlando.app.Models.Calendar;
import com.makerfaireorlando.app.Models.Items;
...
public class EventsFragment extends ListFragment {
    ...
    public void getItemList() throws JSONException {
        //Enter api key for calendar key here
        CalendarClient.get("API KEY", null, new JsonHttpResponseHandler() {
    ...
    public void parseItemList(String jsonString){
        try {
            ...
            ListAdapter adapter = new ArrayAdapter<String>(getActivity(),
                    android.R.layout.simple_list_item_1, android.R.id.text1, mCalTitles);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //String calUrl = mCalendarItems.get(position).htmlLink;
